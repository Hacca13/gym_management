<div class="col-lg-4 col-md-6 col-sm-12" style="margin-top: 2.5%">
    <div class="card" style="border-radius: 10px; background-color: #d6d8d8">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6" style="text-align: left; margin-top: auto; margin-bottom: auto">
                  <a href="modificaEsercizio/{{$exercise->getIdDatabase()}}">
                      <i class="fas fa-edit" style="font-size: 150%; color:rgb(31, 38, 45, 0.8)"></i>
                    </a>
                </div>
        ...
        <div class="card-body" class="card-body" style="background-color: #d6d8d8; border-radius: 0 0 10px 10px; border-right: 0.5px solid rgb(31, 38, 45, 0.6); border-left: 0.5px solid rgb(31, 38, 45, 0.4); border-bottom: 0.5px solid rgb(31, 38, 45, 0.8)">
            <div class="row">
                <div class="col-md-12">
                    <div class="card-body">
