<div class="col-md-12 justify-content-center" style="margin-top: 2.5%">
    ...
    <div class="card" style="background-color: rgba(186, 186, 186, 0.5); border-radius: 10px;">
        <div class="card-body">
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-9 col-sm-12" style="text-align: left; margin-top: auto; margin-bottom: auto">
                    <form action="/admin/exercisesSearchResultsPage" method="post">
                ...
                <div class="col-lg-5 col-md-9 col-sm-12" style="text-align: left; margin-top: auto; margin-bottom: auto">
                    <div class="card" style="background-color: #0b0b0b; border-radius: 10px">
                        <div class="card-body">
                            <form action="/admin/exercisesSearchResultsPage" method="post">
                                @csrf
                                <div class="input-group no-border" >
