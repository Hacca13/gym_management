...
<div class="card card-body" style=" background-color: #d6d8d8;" >
    ...
    <div class="row justify-content-center">
        <div class="col-lg-4 col-md-6 col-sm-5">
            ...
            <div class="input-group">
                <input type="text" class="form-control mydatepicker" placeholder={{$subscription->getStartDate()}}>
        ...
        <div class="col-lg-4 col-md-6 col-sm-5">
            ...
            <div class="input-group">
                <input type="text" class="form-control mydatepicker" placeholder={{$subscription->getEndDate()}}>
                <div class="input-group-append">
                    <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                </div>
            </div>
