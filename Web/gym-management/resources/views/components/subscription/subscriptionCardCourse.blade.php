<div class="card-hover" style="border-radius: 10px; background-color: #d6d8d8; margin-top: 2.5%">
    <a data-toggle="collapse" href="{{'#subCourse' . $loop->index}}" role="button" aria-expanded="false"aria-controls="{{'subCourse' . $loop->index}}">
        <div class="card-body">
...
<div class="col-md-12">
    <div class="collapse multi-collapse" id="{{'subCourse' . $loop->index}}">
