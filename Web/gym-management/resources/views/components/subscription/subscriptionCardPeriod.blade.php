<div class="card-hover" style="border-radius:10px;background-color: #d6d8d8; margin-top: 2.5%" id="scroll" >
    <a data-toggle="collapse" href="{{'#subPeriod' . $loop->index}}" role="button" aria-expanded="false" onclick="border()" aria-controls="{{'subPeriod' . $loop->index}}">
        <div class="card-body" >
