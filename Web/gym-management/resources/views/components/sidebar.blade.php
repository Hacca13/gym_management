<aside class="left-sidebar" data-sidebarbg="skin5">
    <nav class="sidebar-nav">
        <ul id="sidebar-nav">
            <br>
            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-orange sidebar-link" href="/admin/gestioneSchede" aria-expanded="false"><i class="fas fa-clipboard-list"></i><span class="hide-menu">Gestione Schede</span></a></li>
            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/admin/gestioneEsercizi" aria-expanded="false"><i class="fab fa-algolia"></i><span class="hide-menu">Gestione Esercizi</span></a></li>
